...
const Banner = () => {
  ...
  return (
    ...
    <div className='mt-9 p-5 flex flex-col gap-3 lg:justify-center lg:items-center' data-aos="fade-right" >
    ...
    <div className='p-5 flex flex-col gap-3 md:mt-5 lg:mt-9 lg:justify-center lg:items-center' data-aos="fade-left">
