...
const Banner = () => {
  return (
    ...
    <div className='mt-9 p-5 flex flex-col gap-3 lg:justify-center lg:items-center'>
        <img src={banner1} alt="banner-img" className="w-[400px]" / >
        <h1 className='text-2xl font-bold'>Clothing Collection 2030</h1>
    </div>
    <div className=' p-5 flex flex-col gap-3 mt-10 lg:justify-center lg:items-center'>
        <img src={banner2} alt="banner-img" className="w-[400px] "/>
        <h1 className='text-2xl font-bold'>Accessories</h1>
    </div>
    <div className='p-5 flex flex-col gap-3 md:mt-5 lg:mt-9 lg:justify-center lg:items-center'>
