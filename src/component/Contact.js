    ...
    <div>
      ...
      <h4>
       ...
       <div className="flex flex-col gap-3 justify-center items-center pt-4">
          <input type="text" placeholder="Name" className="w-5/6 h-10 text-lg border border-gray-300 rounded-md p-2  outline-none text-gray-400 "/>
          <input type="text" placeholder="Email" className="w-5/6 h-10 text-lg border border-gray-300 rounded-md p-2  outline-none text-gray-400 " />
          <textarea placeholder="Message" className=" w-5/6 h-26 text-lg border border-gray-300 rounded-md p-2  outline-none text-gray-400 "/>
          <button className="border-2 mt-4 border-black bg-white text-dark p-3 hover:bg-black hover:text-white cursor-pointer transition-colors duration-500 rounded-md mb-6"
          >
            Send Message
          </button>
       </div>
